...
export const ADMIN_MENU: AdminMenuItem[] = [
  { href: '/admin/dashboard', label: 'Tổng quan', icon: Gauge, roles: ['admin', 'chuyen_vien', 'giao_dich_vien', 'nhan_vien'] },
  ...
  { href: '/admin/solutions', label: 'Giải pháp số', icon: Lightbulb, roles: ['admin', 'chuyen_vien'] },
  { href: '/admin/stores', label: 'Cửa hàng', icon: Store, roles: ['admin', 'chuyen_vien'] },
  { href: '/admin/registrations', label: 'Đăng ký', icon: ClipboardList, roles: ['admin', 'chuyen_vien', 'giao_dich_vien', 'nhan_vien'] },
  { href: '/admin/contacts', label: 'Liên hệ', icon: Mail, roles: ['admin', 'chuyen_vien', 'giao_dich_vien', 'nhan_vien'] },
  { href: '/admin/sliders', label: 'Slider', icon: GalleryHorizontal, roles: ['admin', 'chuyen_vien'] },
...
export const ADMIN_ROUTE_ROLES: Array<{ prefix: string; roles: UserRole[] }> = [
  ...
  { prefix: '/admin/registrations', roles: ['admin', 'chuyen_vien', 'giao_dich_vien', 'nhan_vien'] },
